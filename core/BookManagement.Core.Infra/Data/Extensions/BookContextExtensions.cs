...
public static class BookContextExtensions
{
    ...
    public static async Task ExecuteStrategyAndRetry(this BookContext _, DbContext dbContext, Func<Task> operation)
    {
    ...
    public static async Task<TResult> ExecuteStrategyAndRetry<TResult>(this BookContext _, DbContext dbContext, Func<Task<TResult>> operation)
    {
    ...
    public static async Task<TResult> ExecuteRetry<TResult>(this BookContext _, Func<Task<TResult>> operation)
    {
