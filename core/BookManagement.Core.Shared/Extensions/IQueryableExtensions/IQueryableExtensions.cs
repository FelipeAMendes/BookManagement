...
namespace BookManagement.Core.Shared.Extensions.IQueryableExtensions;
...
public static class QueryableExtensions
{
    public static IQueryable<T> OrderBy<T>(this IQueryable<T> query, string orderByExpression)
    {
        ...
        var orderByCall = Expression.Call(typeof(Queryable), orderByMethod, new[] {query.ElementType, me.Type},
    ...
    public static IQueryable<TEntity> IgnoreQueryFilters<TEntity>([NotNull] this IQueryable<TEntity> source,
        bool enable) where TEntity : class
    {
        return enable ? source.IgnoreQueryFilters() : source;
    }
}